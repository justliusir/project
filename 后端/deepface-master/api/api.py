...
emotion = {'instance_1': {
    'emotion': {'angry': 0.8526123637055555, 'disgust': 0.0013034104862755555, 'fear': 0.020891733374055555,
                ...
                'neutral': 95.19895882655555}, 'dominant_emotion': 'fear',
    'region': {'x': 71, 'y': 250, 'w': 53, 'h': 53}}}
...
def analyze():
    ...
    toc = time.time()
    # 如果识别失败，就给一个临时的表情emotion
    if isinstance(resp_obj, tuple):
        resp_obj = emotion
    # 如果识别成功，就将表情值传给临时表情emotion储存emotion
    else:
        emotion = resp_obj
